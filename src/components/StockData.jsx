...
export const StockData = ({symbol}) => {
    const [stockData, setDataStock] = useState()
            ...
            {stockData && (
                <div className="row border bg-white rounded shadow-sm p-4 mt-5">
                    ...
                    <div className="col">
                        ...
                        <div><span className="fw-bold">Shares Outstanding: </span>{stockData.sharesOutstanding}</div>
                        <div><span className="fw-bold">url: </span>
